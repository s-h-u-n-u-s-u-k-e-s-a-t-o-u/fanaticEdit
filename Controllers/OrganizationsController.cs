...
public class OrganizationsController : Controller
{
    ...
    public OrganizationsController(FanaticServeContext context)
    {
        _context = context;
    }
    ...
    public async Task<IActionResult> Create([Bind("OrganizationId,Name,Kana,CreatedAt,ModifiedAt")] Organization organization)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(Guid id, [Bind("OrganizationId,Name,Kana,CreatedAt,ModifiedAt")] Organization organization)
    {
